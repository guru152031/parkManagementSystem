...
public class viewemployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<addempbo>ll=parkdao.getemp();
		...
		pw.print("<tr><th>id</th> <th>name</th> <th>email</th> <th>phnno</th> <th>designation</th> "
...
"</td><td>"+"<a href='editcontroller?id="+eb.getId()+"'>  <i style='font-size:24px' class='fas'>&#xf044;</i>\r\n"
		+ "</a></td><td>"+"<a href='deletecontroller?id="+eb.getId()+"'> <i class='far fa-trash-alt' style='font-size:20px;color:red'></i></a></td>");
